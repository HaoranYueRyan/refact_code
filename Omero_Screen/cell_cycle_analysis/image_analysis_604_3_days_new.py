...
path_data = "/Users/rz73/Documents/Lab-book/ImageAnalysis/Greatwall_inhibitor_titration_3_days/"
path_export = path_data + "Figures/"
listdir.mkdir(path_export)
...
data_figure_cell_cycle["cell_line"] = pd.Categorical(data_figure_cell_cycle["cell_line"], categories = ["U2OS", "RPE-1", "HeLa", "BJ1"])
...
data_figure_cell_cycle = data_cell_cycle.copy()
data_figure_cell_cycle["cell_line"] = pd.Categorical(data_figure_cell_cycle["cell_line"], categories = ["U2OS", "RPE-1", "HeLa"])
